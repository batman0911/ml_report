...
được bài toán \ref{eq:7} do không dùng được phương pháp dưới đạo hàm (\textit{subgradient})
trong việc giải bài toán tối ưu (Duchi and Singer 2009). 

Để giải bài toán EAD trong \ref{eq:7} để sinh ra các mẫu đối nghịch, bài viết này đề
...
được trình bày trong tài liệu \footnote{https://arxiv.org/abs/1709.04114}
