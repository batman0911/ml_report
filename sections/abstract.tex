\begin{abstract}
    Các nghiên cứu gần đấy đã chỉ ra tính dễ bị tổn thương của các mạng neuron sâu 
    ...
    ít được xem xét. 
    Trong bài này, tác giả thiết kế một quy trình tấn công DNNs thông qua mẫu đối nghịch
    ...
    công khác nhau. Quan trọng hơn, EAD dẫn đến sự cải tiến trong việc tấn công DNNs và
