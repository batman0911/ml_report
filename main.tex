...
\isthesis{
    ...
    Tấn công Elastic-Net vào Deep Neuron Network \\ 
    ...
    % author-zip={ZIP},
    % author-city={CITY},
    principal-supervisor={PGS.TS. Trần Trọng Hiếu}, % This must be a professor
...
\begin{document}
    ...
    \begin{content}
		...
		\input{sections/03_EAD.tex}
        \input{sections/04_performance_evaluation.tex}
        \input{sections/05_review.tex}
